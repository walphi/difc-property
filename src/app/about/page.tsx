    ...
    <div className="min-h-screen bg-[#FDFCFB] pt-16 lg:pt-20">
      ...
      <div className="relative">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-[#1A1815]/70" />
        </div>
        
        <div className="container relative mx-auto px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
          <div className="mx-auto max-w-3xl text-center">
            <h1 className="font-serif text-4xl font-normal text-white sm:text-5xl leading-[1.15]">
              About DIFC.property
            </h1>
            <p className="mt-6 text-xl leading-relaxed text-white/80 font-light">
      ...
      <div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div className="bg-[#F7F5F2] p-6">
              <div className="mb-4 inline-flex bg-[#F7F5F2] p-3">
                <MapPin className="h-6 w-6 text-[#B8956B]" />
              </div>
              <h3 className="font-serif text-xl font-normal text-[#1A1815] mb-2">DIFC Exclusive</h3>
            ...
            <div className="bg-[#F7F5F2] p-6">
              ...
              <h3 className="font-serif text-xl font-normal text-[#1A1815] mb-2">Verified Listings</h3>
              <p className="text-[#6B5F53]">
            ...
            <div className="bg-[#F7F5F2] p-6">
              ...
              <h3 className="font-serif text-xl font-normal text-[#1A1815] mb-2">Market Intelligence</h3>
              <p className="text-[#6B5F53]">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <Check className="h-6 w-6 text-[#B8956B] shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-medium text-[#1A1815]">Editorial Integrity</h4>
                  <p className="text-[#6B5F53]">We provide objective, informative content without commercial pressure or bias.</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <Check className="h-6 w-6 text-[#B8956B] shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-medium text-[#1A1815]">Data Transparency</h4>
                  <p className="text-[#6B5F53]">All listing data is clearly attributed to source brokers with direct contact information.</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <Check className="h-6 w-6 text-[#B8956B] shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-medium text-[#1A1815]">AI-Search Ready</h4>
                  <p className="text-[#6B5F53]">Our structured data and schema markup ensure DIFC information is easily discoverable by AI systems.</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <Check className="h-6 w-6 text-[#B8956B] shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-medium text-[#1A1815]">Continuous Updates</h4>
                  <p className="text-[#6B5F53]">We continuously monitor DIFC news, developments, and market changes to keep information current.</p>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {buildingsData.map((building) => (
              <Link
                ...
                className="group flex items-center gap-4 border border-[#EDE9E4] p-4 hover:border-[#B8956B] transition-colors"
              >
                <div className="flex h-12 w-12 items-center justify-center bg-[#F7F5F2] group-hover:bg-[#F7F5F2] transition-colors">
                  <Building2 className="h-6 w-6 text-[#6B5F53] group-hover:text-[#B8956B]" />
                </div>
                <div>
                  <h3 className="font-medium text-[#1A1815] group-hover:text-[#B8956B] transition-colors">
                    {building.name}
                  </h3>
                  <p className="text-sm text-[#8B7F71]">{building.buildingType}</p>
                </div>
              </Link>
            ))}
          </div>
        ...
        {/* Contact */}
        <div className="mt-16 bg-[#1A1815] p-8 sm:p-12">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a
                ...
                className="inline-flex items-center gap-2 bg-white px-6 py-3 text-sm font-medium text-[#2D5A4A] hover:bg-[#F7F5F2] transition-colors"
              >
                Call +971 56 219 5566
              </a>
              <a
                href="mailto:contact@difc.property"
                className="inline-flex items-center gap-2 border border-white/30 px-6 py-3 text-sm font-medium text-white hover:text-[#B8956B] transition-colors"
              >
                Email Us
              </a>
            </div>

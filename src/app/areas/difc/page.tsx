...
import { ArrowRight, Building2, MapPin, TrendingUp, Check, Train, ShoppingBag, Utensils } from 'lucide-react'
...
export default function DIFCAreaPage() {
  return (
    <div className="min-h-screen bg-[#FDFCFB] pt-16 lg:pt-20">
      ...
      <div className="relative">
        <div className="absolute inset-0">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#1A1815]/90 via-[#1A1815]/70 to-[#1A1815]/40" />
        </div>
        
        <div className="container relative mx-auto px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
          <div className="max-w-2xl">
            <p className="text-sm font-medium uppercase tracking-[0.2em] text-[#B8956B]">
              Area Guide
            </p>
            <h1 className="mt-4 font-serif text-4xl font-normal tracking-tight text-white sm:text-5xl lg:text-6xl leading-[1.15]">
      ...
      {/* Quick Stats */}
      <div className="border-b border-[#EDE9E4] bg-[#F7F5F3]">
        <div className="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            <div className="text-center">
              <p className="font-serif text-3xl font-medium text-[#B8956B]">4,000+</p>
              <p className="mt-1 text-sm text-[#6B5F53]">Active Companies</p>
            </div>
            <div className="text-center">
              <p className="font-serif text-3xl font-medium text-[#B8956B]">AED 1.48B</p>
              <p className="mt-1 text-sm text-[#6B5F53]">DIFC Net Profit (2025)</p>
            </div>
            <div className="text-center">
              <p className="font-serif text-3xl font-medium text-[#B8956B]">100+</p>
              <p className="mt-1 text-sm text-[#6B5F53]">Countries Represented</p>
            </div>
            <div className="text-center">
              <p className="font-serif text-3xl font-medium text-[#B8956B]">AED 100B</p>
              <p className="mt-1 text-sm text-[#6B5F53]">Expansion Investment</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl mb-16">
          <h2 className="font-serif text-3xl font-normal text-[#1A1815] mb-6">
            Why Choose DIFC?
          </h2>
          <p className="text-lg leading-relaxed text-[#6B5F53] mb-6">
          ...
          <p className="text-lg leading-relaxed text-[#6B5F53]">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 mb-16">
          <div className="border border-[#EDE9E4] bg-[#FDFCFB] p-6">
            <div className="mb-4 inline-flex bg-[#F7F5F3] p-3">
              <Building2 className="h-6 w-6 text-[#B8956B]" />
            </div>
            <h3 className="font-serif text-xl font-normal text-[#1A1815] mb-2">World-Class Residences</h3>
          ...
          <div className="border border-[#EDE9E4] bg-[#FDFCFB] p-6">
            <div className="mb-4 inline-flex bg-[#F7F5F3] p-3">
              <Utensils className="h-6 w-6 text-[#B8956B]" />
            </div>
            <h3 className="font-serif text-xl font-normal text-[#1A1815] mb-2">Exceptional Dining</h3>
            <p className="text-[#6B5F53]">
          ...
          <div className="border border-[#EDE9E4] bg-[#FDFCFB] p-6">
            <div className="mb-4 inline-flex bg-[#F7F5F3] p-3">
              <Train className="h-6 w-6 text-[#B8956B]" />
            </div>
            <h3 className="font-serif text-xl font-normal text-[#1A1815] mb-2">Metro Connectivity</h3>
            <p className="text-[#6B5F53]">
          ...
          <div className="border border-[#EDE9E4] bg-[#FDFCFB] p-6">
            <div className="mb-4 inline-flex bg-[#F7F5F3] p-3">
              <ShoppingBag className="h-6 w-6 text-[#B8956B]" />
            </div>
            <h3 className="font-serif text-xl font-normal text-[#1A1815] mb-2">Retail & Culture</h3>
            <p className="text-[#6B5F53]">
          ...
          <div className="border border-[#EDE9E4] bg-[#FDFCFB] p-6">
            ...
            <h3 className="font-serif text-xl font-normal text-[#1A1815] mb-2">Strong Investment Returns</h3>
            <p className="text-[#6B5F53]">
          ...
          <div className="border border-[#EDE9E4] bg-[#FDFCFB] p-6">
            <div className="mb-4 inline-flex bg-[#F7F5F3] p-3">
              <MapPin className="h-6 w-6 text-[#B8956B]" />
            </div>
            <h3 className="font-serif text-xl font-normal text-[#1A1815] mb-2">Prime Location</h3>
            <p className="text-[#6B5F53]">
        ...
        {/* Buildings Section */}
        <div className="mb-16">
          <h2 className="font-serif text-3xl font-normal text-[#1A1815] mb-8 text-center">
            ...
            {buildingsData.filter(b => b.featured).map((building) => (
              ...
              >
                <div className="aspect-[4/3] relative">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#1A1815]/80 to-transparent" />
                </div>
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <h3 className="font-serif text-xl font-normal text-white group-hover:text-[#D4B896] transition-colors">
                    {building.name}
                  </h3>
          ...
          <div className="mt-8 text-center">
            <Link
              href="/listings"
              className="inline-flex items-center gap-2 text-base font-medium text-[#B8956B] hover:text-[#2D5A4A] transition-colors"
            >
        ...
        {/* Investment Section */}
        <div className="mb-16 bg-[#1A1815] p-8 sm:p-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-3 text-white/70">
                  <Check className="h-5 w-5 text-[#B8956B]" />
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="border border-[#EDE9E4] bg-[#FDFCFB] p-6">
              <h3 className="font-medium text-[#1A1815] mb-2">What makes DIFC different from other Dubai districts?</h3>
              <p className="text-[#6B5F53] text-sm">
            ...
            <div className="border border-[#EDE9E4] bg-[#FDFCFB] p-6">
              <h3 className="font-medium text-[#1A1815] mb-2">Is DIFC suitable for families?</h3>
              <p className="text-[#6B5F53] text-sm">
            ...
            <div className="border border-[#EDE9E4] bg-[#FDFCFB] p-6">
              <h3 className="font-medium text-[#1A1815] mb-2">What are DIFC property prices?</h3>
              <p className="text-[#6B5F53] text-sm">
            ...
            <div className="border border-[#EDE9E4] bg-[#FDFCFB] p-6">
              <h3 className="font-medium text-[#1A1815] mb-2">How is DIFC expanding?</h3>
              <p className="text-[#6B5F53] text-sm">
        ...
        {/* CTA */}
        <div className="bg-[#2D5A4A] p-8 text-center">
          <h2 className="font-serif text-3xl font-normal text-white mb-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/listings"
              className="inline-flex items-center gap-2 bg-white px-6 py-3 text-base font-medium text-[#2D5A4A] hover:bg-[#F7F5F3] transition-colors"
            >
              Browse Properties
              <ArrowRight className="h-5 w-5" />
            </Link>
            <a
              ...
              className="inline-flex items-center gap-2 border border-white/30 bg-white/10 px-6 py-3 text-base font-medium text-white hover:bg-white/20 transition-colors"
            >
